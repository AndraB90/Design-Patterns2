...
public class Bancnota20 extends Bancnota{
    ...
    public void checkAuthority(String bancnotaName, int salar) {
        if (salar / MIN_VALUE > 0){
            ...
            System.out.println("We are sorry, but the limit is 20");
        }
    }

    @Override
    public void grantPayment(String bancnotaName, int salar) {
        System.out.printf("Bancnota 20 approved payment for %d salar to pay with bancnote %s\n", salar, bancnotaName);
    }
}
